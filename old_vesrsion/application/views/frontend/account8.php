                ...
                <article class="col-lg-9 main-right">
                    <div class="panel-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="col-md-5 text-right">
                                            <label for="user_country_of_residence">Country of Residence <i class="fa fa-question-circle" aria-hidden="true"></i></label>
                                        </div>
                                        <div class="col-md-7">
                                            <select id="user_country_of_residence">
                                                <option value=""></option>
                                ...
                                <div class="row">
                                    <div class="panel-footer">
                                        <div class="align-right">
                                            <button class="btn-red">Save Country of Residence</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default social-connec change-pass country-residence">
                            ...
                            <div class="panel-body">
                                <button class="btn-red">Cancel my account</button>
                            </div>
                        </div>
                    </div>
                </article>
