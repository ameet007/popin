...
<div class="rentals-banner">
    <div class="container">
        <div class="pull-left">
            ...
            <p>Give your Colleagues $10 to try Popln and you will also<br /> get $5 in travel credit when they take their first trip.</p>
            <a class="btn-red" href="#">Invite Friends</a>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-md-3 one-third">
                <div class="one-third-main">
                    <div class="img">
                        <img src="<?php echo base_url('theme/front/assests/img/pic-3.jpg')?>" alt="" />
                    </div>
                    <div class="content">
                        <h3>Orange</h3>
                        <p>Mar 3: 8:00a-12p <br/>Station in Historic Orange Circle</p>
                        <ul>
                            <li>
