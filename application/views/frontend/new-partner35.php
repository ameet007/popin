        ...
        <div class="row clearfix">
            ...
            <div class="col-md-4 entire-palce">
                <div class="to-day">
                    <h5>Today</h5>
                    <ul class="clearfix">
                        <li><img src="<?php echo base_url()?>assests/img/calender-img1.jpg" alt="" /></li>
                        <li><img src="<?php echo base_url()?>assests/img/calender-img2.jpg" alt="" /></li>
                        <li><img src="<?php echo base_url()?>assests/img/calender-img3.jpg" alt="" /></li>
                    </ul>
                </div>
            </div>
        </div>
