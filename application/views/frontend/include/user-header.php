                ...
                <div class="row">
                    <div id='cssmenu'>
                        <ul>
                            ...
                            <li <?= ($module_name == 'user' or $module_name == 'trust' or $module_name == 'photo' or $module_name == 'profile' or $module_name == 'reviews' or $module_name == 'references' or $module_name == 'viewProfile') ? 'class="active"' : ''; ?>><a href='<?php echo base_url('user/profile') ?>'>Profile</a></li>
