...
<section class="middle-container new-partner6 new-partner32 new-partner33 new-partner34">
    <div class="container">
        <div class="row clearfix">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="selectbox">
                                            <option selected="selected">8pm</option>
                                            <option>7pm</option>
                                            <option>6pm</option>
                                            <option>5pm</option>
                                            <option>4pm</option>
            ...
            <div class="col-md-4 entire-palce">
                <div class="to-day">
                    <h5>Today</h5>
                    <ul class="clearfix">
                        <li><img src="<?php echo base_url()?>assests/img/today-img1.jpg" alt="" /></li>
                        <li><img src="<?php echo base_url()?>assests/img/today-img2.jpg" alt="" /></li>
                    </ul>
                </div>
            </div>
        </div>
