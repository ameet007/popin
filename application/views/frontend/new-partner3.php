...
?>
<div id="myModal" class="modal fade new-partner-model new-signup" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="felid">
                    <input placeholder="First name" value="" class="textbox" type="text" />
                </div>
                <div class="felid">
                    <input placeholder="Last name" value="" class="textbox" type="text" />
                </div>
                <div class="felid">
                    <input placeholder="Email address" value="" class="icon3 textbox" type="email" />
                </div>
                <div class="felid">
                    <input placeholder="Email address" value="" class="icon4 textbox" type="password" />
                </div>
                ...
                <div class="check-right">
                    <label>
                        <input id="promotional_email" type="checkbox">
                        <span for="promotional_email">I’d like to receive coupons, promotions, surveys, and updates via email about Popln</span>
                    </label>
                </div>
                ...
                <div class="modal-footer clearfix">
                    <div class="pull-left">Alerady have a Popln account?</div>
