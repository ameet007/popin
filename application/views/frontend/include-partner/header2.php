...
<!-- Only for Calander -->
<link href="<?php echo base_url()?>assests/css/fullcalendar.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url()?>assests/css/fullcalendar.print.css" rel="stylesheet" type="text/css" />
<!-- /Only for Calander -->
                ...
                <div class="col-lg-6">
                    <div class="media">
                        ...
                        <div class="media-body">
                           <div class="col-lg-6">
                               <p><strong>Step 3: Get ready for Professionals</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
