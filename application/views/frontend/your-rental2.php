                    ...
                    <div class="receipt-left">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="media">
                                     <div class="media-left">
                                         <a href="#"><img class="media-object" src="<?php echo base_url()?>assests/img/small-pic1.png" alt=""></a>
                                     </div>
                                     <div class="media-body">
                                         <p>Cassidy Garcia</p>
                                     </div>
...
<script src="<?php echo base_url()?>assests/js/nav.js" type="text/javascript"></script>
