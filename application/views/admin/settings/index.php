                                        ...
                                        <div class="tab-pane" id="contact">
                                            <form class="form-horizontal" role="form"  name="contact_settings" id="contact_settings" method="post" action="<?= base_url(ADMIN_DIR.'/settings/contact_settings/'); ?>" enctype="multipart/form-data">
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-sm-9">
	                                                  <input type="text" placeholder="Popin" name="longitude" class="form-control" id="longitude" value="<?= $settings->longitude; ?>">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-sm-9">
	                                                  <input type="text" placeholder="Popin" name="latitude" class="form-control" id="latitude" value="<?= $settings->latitude; ?>">
	                                                </div>
	                                            </div>
